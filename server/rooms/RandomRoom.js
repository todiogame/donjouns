...
class RandomRoom extends colyseus.Room {
    onCreate(options) {
        ...
        this.onMessage("special_effect", (client, message) => {
            console.log(`Received special_effect message from ${client.sessionId}:`, message);
        ...
        this.onMessage("scout_pick", (client, message) => {
            console.log(`Received scout_pick message from ${client.sessionId}:`, message.item_id);
